...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibmQxMzAzMSIsImEiOiJja3JwbjA1bGowMDZnMnBvMHdmcjJkNTN2In0.KJUjocwoqdB8DU2Z8c_aaA';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/nd13031/ckrpo3fq26u9817qrufcf9bgw',
    scrollZoom: false // center: [-118.13276, 34.127341],
    // zoom: 12,
    // interactive: false,
